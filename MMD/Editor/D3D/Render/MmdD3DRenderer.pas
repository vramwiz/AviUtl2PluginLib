...
type
  ...
  private
    ...
    procedure DrawFrame(IncludeModel, IncludeOverlay,
...
procedure TMmdD3DRendererImpl.DrawFrame(IncludeModel, IncludeOverlay,
  PresentFrame: Boolean);
var
...
begin
  ...
  Offset := 0;
  if IncludeModel and (FTriangleBuffer <> nil) and (FTriangleCount > 0) then
  begin
...
begin
  DrawFrame(FModelVisible, FOverlayVisible, True);
end;
