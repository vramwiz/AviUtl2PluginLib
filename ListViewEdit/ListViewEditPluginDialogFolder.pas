...
uses
  ...
  ListViewEx,ListViewEditPluginDialog,ListViewRTTIList;
...
type
	...
	private
		{ Private 宣言 }
    function GetFolders(Index: Integer): TListViewEditPluginFolder;
	public
		{ Public 宣言 }
    ...
    function GetFolder(Handle : THandle ; pList   : PItemIDList;FFlags : Cardinal) : Boolean;
		...
		property Folders[Index: Integer] : TListViewEditPluginFolder read GetFolders ;default;
...
begin
  ...
  SendMessage(FTreeDir.Handle,TV_FIRST+32,32,0); // リスト行の高さを指定
...
begin
  ...
  try
    ...
    SafeSetFocus(FTreeDir);                              // フォーカスが欲しいがなぜか得られない
...
function TListViewEditPluginFolderList.GetFolders(Index: Integer): TListViewEditPluginFolder;
begin
...
initialization
  ...
  ListViewEditFolderDialogId2 := ListViewEditPlugins.RegisterPlugin(TListViewEditFolderDlg2);
