...
var
  ...
  HalfWidth: Double;
begin
  CenterPosition := AIndex + EnsureRange(ALocalProgress, 0.0, 1.0) + 0.5;
  HalfWidth := Max(0.01, ASizePercent) / 200.0;
  AStartPosition := CenterPosition - HalfWidth;
  AEndPosition := CenterPosition + HalfWidth;
end;
